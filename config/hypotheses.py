...
INITIAL_HYPOTHESES: Dict[str, Any] = {
    ...
    # Restart Profit Fallback V1 — absolute USDT protection only when immutable R baseline is unavailable.
    "restart_profit_fallback_enabled": True,
    "restart_profit_fallback_arm_usdt": 5.0,
    "restart_profit_fallback_partial_trigger_usdt": 10.0,
    "restart_profit_fallback_partial_fraction": 0.30,
    "restart_profit_fallback_lock1_trigger_usdt": 10.0,
    "restart_profit_fallback_lock1_usdt": 4.0,
    "restart_profit_fallback_lock2_trigger_usdt": 15.0,
    "restart_profit_fallback_lock2_usdt": 8.0,
    "restart_profit_fallback_lock3_trigger_usdt": 25.0,
    "restart_profit_fallback_lock3_usdt": 15.0,
    "restart_profit_fallback_giveback_arm_usdt": 12.0,
    "restart_profit_fallback_giveback_pct": 0.40,
    "restart_profit_fallback_giveback_min_usdt": 5.0,
    "restart_profit_fallback_exit_min_current_usdt": 2.0,
    "restart_profit_fallback_min_lock_improvement_usdt": 1.0,
