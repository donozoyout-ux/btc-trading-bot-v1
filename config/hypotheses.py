...
INITIAL_HYPOTHESES: Dict[str, Any] = {
    ...
    # Adaptive Profit Protection V2 — INITIAL HYPOTHESES, not optimized claims.
    "profit_protection_enabled": True,
    "profit_arm_r": 0.60,
    "breakeven_trigger_r": 0.75,
    "profit_lock_1_trigger_r": 1.00,
    "profit_lock_1_r": 0.20,
    "profit_lock_2_trigger_r": 1.50,
    "profit_lock_2_r": 0.60,
    "profit_lock_3_trigger_r": 2.00,
    "profit_lock_3_r": 1.10,
    "mfe_giveback_enabled": True,
    "mfe_giveback_arm_r": 0.80,
    "mfe_giveback_warn_r": 0.35,
    "mfe_giveback_exit_r": 0.55,
    "profit_fade_partial_min_r": 0.80,
    "profit_fade_partial_fraction": 0.35,
    # Adaptive Profit Capture V3 — execution-poll guard, initial hypotheses.
    "fast_profit_guard_enabled": True,
    "fast_profit_arm_r": 0.40,
    "fast_profit_breakeven_trigger_r": 0.60,
    "fast_profit_breakeven_lock_r": 0.00,
    "fast_profit_lock_075_trigger_r": 0.75,
    "fast_profit_lock_075_r": 0.10,
    "fast_profit_partial_trigger_r": 1.00,
    "fast_profit_partial_fraction": 0.30,
    "fast_profit_lock_1_trigger_r": 1.00,
    "fast_profit_lock_1_r": 0.30,
    "fast_profit_lock_2_trigger_r": 1.25,
    "fast_profit_lock_2_r": 0.60,
    "fast_profit_lock_3_trigger_r": 1.50,
    "fast_profit_lock_3_r": 0.90,
    "fast_profit_lock_4_trigger_r": 2.00,
    "fast_profit_lock_4_r": 1.30,
    "fast_profit_trail_arm_r": 1.25,
    "fast_profit_trail_gap_r": 0.70,
    "fast_profit_fade_exit_arm_r": 1.25,
    "fast_profit_fade_exit_giveback_r": 0.60,
    "fast_profit_fade_exit_min_current_r": 0.10,
    "fast_profit_min_stop_improvement_r": 0.05,
    # Restart fallback when immutable initial risk cannot be proven. These are
    # entry-relative price-move fractions, not R. Example: 0.0040 = 0.40%.
    "baselineless_profit_guard_enabled": True,
    "baselineless_profit_arm_pct": 0.0015,
    "baselineless_lock_1_trigger_pct": 0.0020,
    "baselineless_lock_1_pct": 0.0010,
    "baselineless_lock_2_trigger_pct": 0.0030,
    "baselineless_lock_2_pct": 0.0015,
    "baselineless_lock_3_trigger_pct": 0.0040,
    "baselineless_lock_3_pct": 0.0022,
    "baselineless_lock_4_trigger_pct": 0.0060,
    "baselineless_lock_4_pct": 0.0035,
    "baselineless_lock_5_trigger_pct": 0.0080,
    "baselineless_lock_5_pct": 0.0050,
    "baselineless_trail_arm_pct": 0.0040,
    "baselineless_trail_gap_pct": 0.0025,
    "baselineless_exit_arm_pct": 0.0035,
    "baselineless_exit_giveback_fraction": 0.40,
    "baselineless_exit_min_profit_pct": 0.0005,
    "baselineless_min_stop_improvement_pct": 0.0002,
